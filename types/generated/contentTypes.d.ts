...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    olfactivefamily: Schema.Attribute.String;
    pyramidnote: Schema.Attribute.String;
    topnotes: Schema.Attribute.String;
    middlenotes: Schema.Attribute.String;
    basenotes: Schema.Attribute.String;
    recommendedusage: Schema.Attribute.String;
    totalIngredients: Schema.Attribute.String;
